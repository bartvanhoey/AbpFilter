...
namespace AbpFilter.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpFilter") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpFilter", DisplayName = "AbpFilter API", Resources = { "AbpFilter" }
            });
        }
    }
